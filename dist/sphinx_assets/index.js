...
/***/ "./src/declarations/sphinx/index.js":
/*!******************************************!*\
  !*** ./src/declarations/sphinx/index.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "idlFactory": () => (/* reexport safe */ _sphinx_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory),
/* harmony export */   "canisterId": () => (/* binding */ canisterId),
/* harmony export */   "createActor": () => (/* binding */ createActor),
/* harmony export */   "sphinx": () => (/* binding */ sphinx)
/* harmony export */ });
...
/* harmony import */ var _sphinx_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sphinx.did.js */ "./src/declarations/sphinx/sphinx.did.js");
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./sphinx.did.js")._SERVICE>}
 */
 const createActor = (canisterId, options) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_sphinx_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
/**
 * A ready-to-use agent for the sphinx canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./sphinx.did.js")._SERVICE>}
 */
 const sphinx = createActor(canisterId);


/***/ }),

/***/ "./src/declarations/sphinx/sphinx.did.js":
/*!***********************************************!*\
  !*** ./src/declarations/sphinx/sphinx.did.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
/*!****************************************!*\
  !*** ./src/sphinx_assets/src/index.js ***!
  \****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_sphinx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/sphinx */ "./src/declarations/sphinx/index.js");
...
document.querySelector("form").addEventListener("submit", async function (event) {
  ...
  if (document.getElementById("input-amount").value.length != 0) {
    await _declarations_sphinx__WEBPACK_IMPORTED_MODULE_0__.sphinx.topUp(inputAmount);
  }

  if (document.getElementById("withdrawal-amount").value.length != 0) {
    await _declarations_sphinx__WEBPACK_IMPORTED_MODULE_0__.sphinx.withdrawl(outputAmount);
  }

  await _declarations_sphinx__WEBPACK_IMPORTED_MODULE_0__.sphinx.compound();
...
async function update() {
  const currentAmount = await _declarations_sphinx__WEBPACK_IMPORTED_MODULE_0__.sphinx.checkBalance();
